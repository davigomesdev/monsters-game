import{k as x,m as b,a as D,C as w,o as j,$ as l,x as c,R as h,N as F,M as L,S as y,d as J,y as G,D as M,r as q,l as K,a4 as Q,a5 as X,q as Z,E as ee}from"./index-DF3qgYI9.js";import{n as d,r as u,c as v,U as E}from"./index-C0VTGy34.js";import"./index-ChP016_X.js";import"./index-DsUDIhnL.js";import"./index-ByRsesJw.js";import{e as z,n as H}from"./ref-DqSBMHKM.js";import"./index-B1Hi-rh1.js";import"./index-Cx4tL-_t.js";import"./index-DcrbUReb.js";import{S as Y}from"./SwapController-m_xoOR1g.js";import"./index-DMs4k68e.js";import"./index-BtpvvPfV.js";import"./index-J3-UIndA.js";import"./index-DCJJTL5F.js";import{o as te}from"./if-defined-bRe2KTT8.js";import"./index-OxDcOr7c.js";import"./index-8-GBbSPF.js";const ie=x`
  :host {
    width: 100%;
    height: 100px;
...
`;var P=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let $=class extends b{constructor(){super(...arguments),this.inputElementRef=z(),this.instructionElementRef=z(),this.readOnly=!1,this.instructionHidden=!!this.value,this.pasting=!1,this.onDebouncedSearch=D.debounce(async t=>{if(!t.length){this.setReceiverAddress("");return}const n=w.state.activeChain;if(D.isAddress(t,n)){this.setReceiverAddress(t);return}try{const o=await j.getEnsAddress(t);if(o){l.setReceiverProfileName(t),l.setReceiverAddress(o);const i=await j.getEnsAvatar(t);l.setReceiverProfileImageUrl(i||void 0)}}catch{this.setReceiverAddress(t)}finally{l.setLoading(!1)}})}firstUpdated(){this.value&&(this.instructionHidden=!0),this.checkHidden()}render(){return this.readOnly?c` <wui-flex
